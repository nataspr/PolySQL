      ...
      <div className="profile-contact">
        <div className="profile-container09">
          <div className="profile-form">
            <h2 className="profile-text18 HeadingOne">Скажите Привет!</h2>
            <span className="profile-text19 Lead">
              Мы будем рады получить от Вас обратную связь.
            </span>
            <form className="profile-form1">
              <label className="profile-text20 Label">Моё имя</label>
              <input
                type="text"
                placeholder="ФИО"
                className="profile-textinput Small input"
              />
              <label className="profile-text21 Label">
                Я хочу рассказать о
              </label>
              <input
                type="text"
                placeholder="Меня волнует..."
            ...
            <div className="profile-container12">
              ...
              <div className="profile-container13">
                ...
                <div className="profile-container15">
                  ...
                  <a href="mailto:hello@creative-tim.com?subject=" className="profile-link1 Small">
