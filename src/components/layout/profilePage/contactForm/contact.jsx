            ...
            <div className="container09">
              ...
              Мы будем рады получить от Вас обратную связь.
                    ...
                    <form className="form1">
                        <label className="text20 Label">Моё имя</label>
                        <input
                            type="text"
                            placeholder="ФИО"
                            className="profile-textinput Small input"
                        />
                        <label className="text20 Label">
                            Я хочу рассказать о
                        </label>
                        <input
                            type="text"
                            ...
                            className="profile-textinput Small input"
                        />
                        <label className="text20 Label">Моё сообщение</label>
                        <textarea
                            rows="8"
                        ...
                        <div className="container13">
                            <div className="container14">
                                <svg viewBox="0 0 1024 1024" className="profile-icon02">
                                    <path
                                        d="M742 460l-94-94q-18-18-10-44 24-72 24-152 0-18 12-30t30-12h150q18 0 30 12t12 30q0 300-213 513t-513 213q-18 0-30-12t-12-30v-150q0-18 12-30t30-12q80 0 152-24 24-10 44 10l94 94q186-96 282-282z"></path>
                                </svg>
                                <a href="tel:+12 345 678 910" className="profile-link Small">
                                    (+12) 345 678 910
                                </a>
                            </div>
                            <div className="container14">
                                ...
                                <a href="mailto:hello@creative-tim.com?subject=" className="profile-link Small">
                            ...
                            <div className="container14">
                                <svg viewBox="0 0 1024 1024" className="profile-icon02">
                                    <path
                                        d="M512 490q44 0 75-31t31-75-31-75-75-31-75 31-31 75 31 75 75 31zM512 86q124 0 211 87t87 211q0 62-31 142t-75 150-87 131-73 97l-32 34q-12-14-32-37t-72-92-91-134-71-147-32-144q0-124 87-211t211-87z"></path>
                                </svg>
                                <span className="text25">
                      Peter the Great St.Petersburg Polytechnic University, 195251
                  </span>
                            </div>
                        </div>
                        <div className="profile-container17">
                            <svg viewBox="0 0 878 1024" className="profile-icon08">
                                <path
